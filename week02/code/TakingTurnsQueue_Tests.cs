...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueue function in PersonQueue was inserting people in index 0 each time instead of the back
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The GetNextPerson() did not include a conditional statement for users with infinite turns(0 or less)
